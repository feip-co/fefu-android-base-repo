...
import ru.fefu.activitytracker.Activity
import java.text.SimpleDateFormat
import java.util.*

fun Activity.getDistanceDisplayText(context: Context): String = when {
    distance <= 1000 -> context.resources.getQuantityString(R.plurals.meters, distance, distance)
